...
<img src="https://i.imgur.com/j8sACUe.png" alt="drawing" width="300"/><img src="https://i.imgur.com/6pDO6SN.png" alt="drawing" width="350"/>
On the left hand side, it's more difficult to construe the image as a single object, though with some imagination, it's still possible to view the different arrows as corners of a cube. This task becomes much easier when lines are drawn delineating the erased parts of the image; with the new lines, the structure of the cube is much more visible, despite the fact that that no lines were actually drawn to delineate the cube.
...
2.  How many clusters do we have in this algorithm?
    ...
    1.  This clustering process creates a dendrogram (essentially, a
        ...
        ![](https://i.imgur.com/MQVpwaB.png)

3.  The algorithm, officially:


    ![](https://i.imgur.com/OrdM8gy.png)
